...
(define (remove-primeiro x lst)
  (define (remove-primeiro-acc lst acc-l)
    (cond [(empty? lst) acc-l]
          [(equal? (first lst) x) (append acc-l (rest lst))]
          [else (remove-primeiro-acc (rest lst) (append acc-l (list (first lst))))]))
  (remove-primeiro-acc lst '()))
...
(define (remove-todos x lst)
  (define (remove-todos-acc lst acc-l)
    (cond [(empty? lst)            acc-l]
          [(equal? (first lst) x) (remove-todos-acc (rest lst) acc-l)]
          [else                   (remove-todos-acc (rest lst) (append acc-l (list (first lst))))]))
  (remove-todos-acc lst '()))
...
(define (combine l1 l2)
  (define (combine-acc l1 l2 acc-l)
    (cond [(empty? l1) acc-l]
          [(empty? l2) acc-l]
          [else        (combine-acc (rest l1) (rest l2)
                                    (append acc-l (cons (list (first l1) (first l2)) '())))]))
  (combine-acc l1 l2 '()))
